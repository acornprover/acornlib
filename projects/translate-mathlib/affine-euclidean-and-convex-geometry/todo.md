...
- [ ] Add affine maps (structure, identity, extensionality, preservation lemma done; still need composition, preimage of subspaces, barycentric coordinates, and affine combinations)
