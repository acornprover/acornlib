...
The remaining morphism and subobject items are deferred design cleanups. Product work should revisit bundled `Pair[A, B]` instances. The next non-design execution frontier is [quotients](quotients/todo.md), where representative-level monoid/group quotient laws are being rounded out before bundled instances or universal properties.
