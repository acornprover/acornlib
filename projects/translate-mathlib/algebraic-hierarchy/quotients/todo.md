...
- `src/normal_subgroup.ac` now has the named `normal_subgroup_quotient_projected_power_law` predicate, the proved `normal_subgroup_quotient_pow_mk_all` all-exponent theorem, the projection-facing alias `normal_subgroup_quotient_project_pow_all`, and the projection-facing exponent-addition alias `normal_subgroup_quotient_project_pow_add`.
