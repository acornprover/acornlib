...
- [ ] Connect quotients to the first isomorphism theorem (induced maps now exist for group/ring/additive-group kernel quotients; the homomorphism property is now proved for all kernel quotients; remaining: surjectivity onto the image)
- [ ] Prove surjectivity of the kernel-quotient induced maps onto the image (homomorphism property done for group/ring/additive-group/monoid/additive-monoid/semiring/linear-map)
