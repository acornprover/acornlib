...
- [ ] Prove the homomorphism property of the kernel-quotient induced maps (ring/additive-group/monoid/additive-monoid/semiring/linear-map; group done) and surjectivity onto the image
