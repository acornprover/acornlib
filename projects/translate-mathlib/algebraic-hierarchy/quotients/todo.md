...
- [ ] Prove the homomorphism property of the kernel-quotient induced maps (additive-monoid/semiring/linear-map; group/ring/additive-group/monoid done) and surjectivity onto the image
