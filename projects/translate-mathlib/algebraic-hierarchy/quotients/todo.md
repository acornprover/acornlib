...
- [ ] Prove the homomorphism property of the kernel-quotient induced maps (additive-group/monoid/additive-monoid/semiring/linear-map; group and ring done) and surjectivity onto the image
