...
- [ ] Add projection-facing aliases for `normal_subgroup_quotient_pow_mk_all` (e.g. via `normal_subgroup_quotient_project`).
...
- `src/normal_subgroup.ac` now has the named `normal_subgroup_quotient_projected_power_law` predicate and the proved `normal_subgroup_quotient_pow_mk_all` all-exponent theorem.
