...
- `src/normal_subgroup.ac` now has the named `normal_subgroup_quotient_projected_power_law` predicate, the proved `normal_subgroup_quotient_pow_mk_all` all-exponent theorem, and the projection-facing alias `normal_subgroup_quotient_project_pow_all`.
