...
- [ ] Prove the homomorphism property of the kernel-quotient induced maps (monoid/additive-monoid/semiring/linear-map; group/ring/additive-group done) and surjectivity onto the image
