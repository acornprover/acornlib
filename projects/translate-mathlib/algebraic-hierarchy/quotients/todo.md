...
- [ ] Prove the homomorphism property of the kernel-quotient induced maps (group/ring/additive-group/monoid/additive-monoid/semiring/linear-map) and surjectivity onto the image
