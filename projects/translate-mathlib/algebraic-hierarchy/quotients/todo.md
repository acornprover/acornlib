...
- [ ] Prove the normal-subgroup quotient projected-power all-power law by decomposing the induction wrapper around `normal_subgroup_quotient_projected_power_law`, `normal_subgroup_quotient_pow_mk_zero`, and `normal_subgroup_quotient_pow_mk_suc_step`.
...
- `src/normal_subgroup.ac` now has the named `normal_subgroup_quotient_projected_power_law` predicate for the all-power induction target.
