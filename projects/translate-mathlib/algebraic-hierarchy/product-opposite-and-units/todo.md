...
Progress: `src/function_product_algebra.ac` now specializes the shared function-level pointwise API to binary products of function spaces, with evaluation, coordinate, associativity, commutativity, identity, inverse, semiring distributivity, and zero-absorption laws. It also provides a ternary product layer with evaluation, constructors, pointwise operations, coordinate projection lemmas, eta, evaluation laws for pointwise addition and multiplication, additive and multiplicative associativity/commutativity/identity/inverse laws, and semiring distributivity and zero-absorption laws. Higher-arity laws and bundled product instances remain deferred until generic bundled instances are reliable.
