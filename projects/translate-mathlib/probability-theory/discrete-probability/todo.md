...
- [ ] Add monotonicity of `finite_set_sum` (over an ordered `AddCommMonoid` with nonneg pointwise inequality), and split-by-membership lemmas (`finite_set_sum_insert`, `finite_set_sum_disjoint_union`).
