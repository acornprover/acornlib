...
- [ ] Define charted spaces and manifolds
  ...
  - [x] Chart coordinate maps are injective on their respective domains (`chart_to_fun_inj_on_source`, `chart_inv_fun_inj_on_target`)
  - [x] Charted-space corollaries of chart injectivity (`charted_space_chart_at_to_fun_inj`, `charted_space_chart_at_inv_fun_inj`)
