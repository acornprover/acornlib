...
- `src/pair_order.ac` now has strict iff characterizations of componentwise pair meet/join versus their arguments: `pair_meet_lt_left_iff_not_lte`, `pair_meet_lt_right_iff_not_lte`, `pair_join_lt_left_iff_not_lte`, and `pair_join_lt_right_iff_not_lte`.
