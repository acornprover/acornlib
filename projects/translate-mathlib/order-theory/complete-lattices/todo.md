...
- `src/set_lattice.ac` now has ternary natural-family slice constructors for fixing any one index and iterating sequence unions or intersections over the other two indices, plus unfolding aliases for each associated family.
