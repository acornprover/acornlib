...
- [ ] Add ternary natural-family sequence reindexing and preimage/image transport wrappers on top of the verified ternary slice membership, LUB/GLB, monotonicity, and complement API
- [ ] Continue downstream-driven unbundled set complete-lattice wrappers beyond the current indexed reindexing, list, range, monotone-range, sequence-family, sequence-family reindexing/distributivity, family distributivity, preimage, image-over-supremum, binary-family, binary-family transport, independent-product infimum/supremum family API through quinary products, iterated binary-sequence reindexing, iterated binary-sequence transport/universal-property API, iterated binary-sequence complement-duality API, ternary natural-family slice constructors, ternary slice membership/LUB/GLB wrappers, and ternary natural-family monotonicity/complement wrappers
...
- `src/set_lattice.ac` now has ternary natural-family slice constructors for fixing any one index and iterating sequence unions or intersections over the other two indices, plus unfolding aliases, membership characterizations, member bound lemmas, subset universal properties, and LUB/GLB packages for each associated family.
- `src/set_lattice.ac` now has ternary natural-family pointwise monotonicity wrappers, named preimage/image/complement/reindexing family constructors, slice complement equalities, and slice-level De Morgan equalities for sequence unions and intersections.
...
- Fixed-arity independent-product wrappers intentionally stop at quinary products. Higher arities should be expressed through indexed families or a named abstraction unless a specific downstream theorem justifies a narrow exception.
