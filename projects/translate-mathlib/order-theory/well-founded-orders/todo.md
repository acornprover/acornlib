...
- The strict-natural-order recursion API also includes a concrete primitive-recursive function constructor, a named primitive-recursion step wrapper, and zero/successor equations for both the constructor and the step.
