...
- `src/well_founded.ac` now has `relation_pushforward_is_well_founded_of_injection`: the pushforward of a well-founded relation along an injective function is well-founded, generalizing the existing bijection version.
