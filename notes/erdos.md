...
Scoring method: I first assign a heuristic raw score, then rank-normalize it to an integer from 100 to 0. Positive signals include an already formalized statement, no or low recorded prize, OEIS/computational hooks, concrete finite/combinatorial tags, short statements, and remarks suggesting equivalent formulations or known sharp partial results. Negative signals include high prizes, famous early catalogue problems, and tags or wording pointing to deep analytic number theory, large Ramsey gaps, irrationality, set theory, or long continuous arguments. Because scores are rank-normalized, no score is shared by more than 7 problems.

The score estimates how promising the problem looks for near-term AI assistance, including literature discovery, computational search, formalization, and proof reconstruction. It does not estimate mathematical importance.

## Ranked Open Problems

### 1. Problem 1085 - Score 100
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, known-best bounds, finite search hooks, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 2. Problem 1104 - Score 100
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 3. Problem 108 - Score 100
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, chromatic number, and cycles) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 4. Problem 1084 - Score 100
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 5. Problem 757 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry, distances, and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 6. Problem 212 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 7. Problem 96 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry, distances, and convex) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 8. Problem 155 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 9. Problem 920 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 10. Problem 376 - Score 99
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, binomial coefficients, and base representations) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 11. Problem 730 - Score 98
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, binomial coefficients, and base representations) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 12. Problem 213 - Score 98
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 14. Problem 503 - Score 98
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, additive combinatorics, and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 16. Problem 184 - Score 98
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and cycles) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 17. Problem 82 - Score 97
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 18. Problem 750 - Score 97
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, sidon sets, and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 21. Problem 396 - Score 97
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 22. Problem 274 - Score 97
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (group theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 23. Problem 98 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 24. Problem 1145 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and additive basis) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 25. Problem 170 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 26. Problem 1054 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 27. Problem 1095 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 28. Problem 849 - Score 96
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 29. Problem 1094 - Score 95
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 30. Problem 321 - Score 95
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 31. Problem 85 - Score 95
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 34. Problem 655 - Score 95
...
### 36. Problem 359 - Score 94
- Site: https://www.erdosproblems.com/359
- Tags: number theory
- Prize: no; formalized: yes; OEIS: A002048
- Statement: Let $a_1 0$?
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 37. Problem 727 - Score 94
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 41. Problem 422 - Score 94
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 43. Problem 241 - Score 93
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (additive combinatorics and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 44. Problem 406 - Score 93
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and base representations) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 45. Problem 1097 - Score 93
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has equivalent formulation, finite search hooks, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 46. Problem 975 - Score 93
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, divisors, and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 48. Problem 479 - Score 92
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 50. Problem 1073 - Score 92
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 52. Problem 1063 - Score 92
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 54. Problem 288 - Score 91
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 55. Problem 1061 - Score 91
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 57. Problem 414 - Score 91
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and iterated functions) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 58. Problem 295 - Score 91
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 61. Problem 304 - Score 90
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 63. Problem 346 - Score 90
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and complete sequences) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 64. Problem 313 - Score 90
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 65. Problem 938 - Score 90
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 73. Problem 373 - Score 88
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 83. Problem 349 - Score 87
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics and intersecting family) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 88. Problem 945 - Score 86
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 90. Problem 1194 - Score 86
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics, additive basis, and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 91. Problem 1199 - Score 86
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 92. Problem 886 - Score 85
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 93. Problem 887 - Score 85
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and additive basis) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 102. Problem 881 - Score 84
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 104. Problem 416 - Score 83
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 111. Problem 1 - Score 82
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (number theory and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, equivalent formulation, known-best bounds, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 112. Problem 99 - Score 82
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 113. Problem 901 - Score 82
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 114. Problem 873 - Score 82
- Site: https://www.erdosproblems.com/873
- Tags: number theory
- Prize: no; formalized: yes; OEIS: none
- Statement: Let $A=\{a_1 0$, there exists some $k$ such that\[F(A,X,k)<X^\epsilon?\]
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 115. Problem 943 - Score 82
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 116. Problem 324 - Score 81
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and powers) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 117. Problem 387 - Score 81
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 118. Problem 329 - Score 81
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 122. Problem 1072 - Score 81
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 131. Problem 385 - Score 79
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 132. Problem 1065 - Score 79
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and powers) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 136. Problem 1093 - Score 78
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($10) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 140. Problem 573 - Score 78
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and turan number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 141. Problem 1086 - Score 77
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has equivalent formulation, known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 142. Problem 1083 - Score 77
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, hypergraphs, and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 144. Problem 826 - Score 77
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (hypergraphs and turan number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 153. Problem 1158 - Score 76
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 159. Problem 859 - Score 75
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 164. Problem 562 - Score 74
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, ramsey theory, and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 165. Problem 39 - Score 74
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (number theory, sidon sets, and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 166. Problem 724 - Score 73
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 167. Problem 704 - Score 73
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, geometry, and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 168. Problem 1142 - Score 73
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 169. Problem 828 - Score 73
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and powerful) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 184. Problem 1016 - Score 71
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and cycles) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 185. Problem 500 - Score 70
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (graph theory, hypergraphs, and turan number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 186. Problem 10 - Score 70
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory, additive basis, and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 187. Problem 931 - Score 70
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis, polynomials, and probability) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 192. Problem 52 - Score 69
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($250) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (number theory and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 193. Problem 470 - Score 69
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($10) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 194. Problem 738 - Score 69
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 197. Problem 917 - Score 68
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 199. Problem 236 - Score 68
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (additive combinatorics and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 203. Problem 377 - Score 67
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and polynomials) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 205. Problem 906 - Score 67
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and iterated functions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 206. Problem 774 - Score 67
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 207. Problem 41 - Score 67
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, sidon sets, and squares) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 210. Problem 626 - Score 66
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, chromatic number, and cycles) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 211. Problem 361 - Score 66
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 213. Problem 536 - Score 66
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and probability) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 216. Problem 725 - Score 65
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 222. Problem 445 - Score 64
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (number theory and additive basis) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 226. Problem 30 - Score 64
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($1000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (number theory, sidon sets, and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 227. Problem 640 - Score 64
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 228. Problem 1208 - Score 63
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, sidon sets, and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 232. Problem 9 - Score 63
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 234. Problem 996 - Score 62
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory, primes, and binomial coefficients) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 237. Problem 160 - Score 62
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 244. Problem 1017 - Score 61
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 245. Problem 579 - Score 61
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and additive basis) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 251. Problem 719 - Score 60
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 258. Problem 486 - Score 59
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and primitive sets) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 259. Problem 66 - Score 58
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and squares) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, known-best bounds, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 263. Problem 1207 - Score 58
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 269. Problem 850 - Score 57
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (graph theory, ramsey theory, and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 273. Problem 1035 - Score 56
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry, distances, and convex) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 276. Problem 1206 - Score 56
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 277. Problem 1159 - Score 56
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (graph theory, turan number, and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 284. Problem 249 - Score 54
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and irrationality) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 285. Problem 454 - Score 54
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (diophantine approximation and number theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 289. Problem 32 - Score 54
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($1000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 293. Problem 156 - Score 53
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 294. Problem 1160 - Score 53
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (group theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 295. Problem 320 - Score 53
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 296. Problem 148 - Score 52
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 300. Problem 1111 - Score 52
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 303. Problem 234 - Score 51
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 307. Problem 393 - Score 51
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 308. Problem 802 - Score 51
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and binomial coefficients) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 310. Problem 791 - Score 50
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 311. Problem 840 - Score 50
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 312. Problem 528 - Score 50
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 313. Problem 529 - Score 50
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and probability) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 314. Problem 669 - Score 50
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (additive combinatorics, primes, and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 319. Problem 252 - Score 49
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($250) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags and statement (graph theory and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 325. Problem 138 - Score 48
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 326. Problem 934 - Score 48
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 330. Problem 1112 - Score 47
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (primes and covering systems) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 332. Problem 428 - Score 47
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 333. Problem 1049 - Score 47
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (irrationality) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 334. Problem 509 - Score 46
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 339. Problem 1103 - Score 46
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and additive combinatorics) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 342. Problem 81 - Score 45
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 344. Problem 302 - Score 45
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and complete sequences) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 348. Problem 662 - Score 44
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (graph theory and turan number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 350. Problem 713 - Score 44
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 354. Problem 119 - Score 43
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags and statement (analysis and polynomials) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 355. Problem 423 - Score 43
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and powers) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 360. Problem 875 - Score 42
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and planar graphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 364. Problem 584 - Score 42
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, computational evidence, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 374. Problem 478 - Score 40
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, known-best bounds, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 375. Problem 928 - Score 40
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 377. Problem 65 - Score 39
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 380. Problem 279 - Score 39
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory, covering systems, and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 381. Problem 123 - Score 39
...
### 382. Problem 1189 - Score 39
- Site: https://www.erdosproblems.com/1189
- Tags: number theory, covering systems
- Prize: no; formalized: no; OEIS: possible
- Statement: Call a set of distinct integers $1 1$) form an irreducible covering set?
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 383. Problem 411 - Score 38
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and iterated functions) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 384. Problem 1005 - Score 38
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 388. Problem 693 - Score 38
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 389. Problem 805 - Score 38
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (additive combinatorics and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 391. Problem 788 - Score 37
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (graph theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 398. Problem 218 - Score 36
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 399. Problem 513 - Score 36
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and diophantine approximation) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 401. Problem 143 - Score 36
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (primitive sets) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 402. Problem 700 - Score 35
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 404. Problem 278 - Score 35
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and covering systems) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 405. Problem 338 - Score 35
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and additive basis) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 406. Problem 149 - Score 35
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 408. Problem 661 - Score 34
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($50) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (geometry and distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 409. Problem 68 - Score 34
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and divisors) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 416. Problem 819 - Score 33
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 419. Problem 827 - Score 33
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (additive combinatorics and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 428. Problem 870 - Score 31
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has computational evidence, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 434. Problem 1057 - Score 30
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 435. Problem 544 - Score 30
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and unit fractions) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 437. Problem 1186 - Score 30
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics, ramsey theory, and discrepancy) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 442. Problem 611 - Score 29
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (combinatorics and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 444. Problem 778 - Score 29
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory, additive combinatorics, and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 450. Problem 131 - Score 28
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and probability) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 452. Problem 838 - Score 27
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and convex) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 453. Problem 970 - Score 27
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory, set theory, and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 457. Problem 890 - Score 27
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis, probability, and polynomials) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 464. Problem 995 - Score 25
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and discrepancy) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 465. Problem 963 - Score 25
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory, ramsey theory, and hypergraphs) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 468. Problem 425 - Score 25
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 472. Problem 680 - Score 24
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (geometry and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 476. Problem 181 - Score 24
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and polynomials) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 478. Problem 117 - Score 23
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (primes and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 486. Problem 555 - Score 22
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis, polynomials, and probability) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 491. Problem 1110 - Score 21
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis and polynomials) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 494. Problem 1132 - Score 21
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and graph theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 496. Problem 159 - Score 20
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 502. Problem 768 - Score 19
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (additive combinatorics, arithmetic progressions, and discrepancy) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 505. Problem 415 - Score 19
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (distances) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 507. Problem 1191 - Score 19
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($1000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (additive combinatorics and sidon sets) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 508. Problem 1143 - Score 18
- Site: https://www.erdosproblems.com/1143
- Tags: number theory, primes
- Prize: no; formalized: no; OEIS: none
- Statement: Let $p_1 2$.
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory and primes) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has exact bound/construction language, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 509. Problem 382 - Score 18
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has equivalent formulation, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 520. Problem 709 - Score 16
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($250) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (graph theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 525. Problem 1029 - Score 16
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($100) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (graph theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 526. Problem 269 - Score 15
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags and statement (graph theory, chromatic number, and cycles) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 528. Problem 452 - Score 15
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (discrepancy and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is mostly literature discovery or incremental lemma assembly; a genuinely new proof would probably need deep analytic number theory. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 532. Problem 80 - Score 14
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($25) is small, so I treat it as only a mild difficulty signal rather than a major warning sign. The tags (geometry) are moderately favorable because AI can explore configurations, but geometry can require delicate continuous arguments. A likely AI route is geometric case analysis plus computational exploration of candidate configurations, but continuous geometry still adds formalization overhead. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 536. Problem 593 - Score 14
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags and statement (set theory, graph theory, hypergraphs, and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 537. Problem 568 - Score 14
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (additive combinatorics and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 541. Problem 122 - Score 13
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (analysis) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 546. Problem 1045 - Score 12
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and factorials) give AI useful handles: searchable sequences, extremal examples, and many reusable lemmas from additive or elementary number theory. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 554. Problem 1209 - Score 11
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (number theory and primitive sets) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 562. Problem 878 - Score 10
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags (graph theory and ramsey theory) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has OEIS links, equivalent formulation, finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 565. Problem 1212 - Score 9
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($1000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (graph theory and chromatic number) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 568. Problem 456 - Score 9
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory, primes, and binomial coefficients) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 574. Problem 708 - Score 8
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($10000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags and statement (additive combinatorics and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, known-best bounds, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 576. Problem 1171 - Score 7
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory and ramsey theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 577. Problem 462 - Score 7
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($500) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags (combinatorics, ramsey theory, and discrepancy) are favorable for AI because finite combinatorial problems often admit computational exploration, database search, and local proof reconstruction. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 586. Problem 1175 - Score 6
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 587. Problem 602 - Score 6
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (combinatorics and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 588. Problem 501 - Score 5
...
### 589. Problem 1170 - Score 5
- Site: https://www.erdosproblems.com/1170
- Tags: set theory, ramsey theory
- Prize: no; formalized: no; OEIS: none
- Statement: Is it consistent that\[\omega_2\to (\alpha)_2^2\]for every $\alpha <\omega_2$?
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory and ramsey theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is computational bounds or SAT-style search, though large Ramsey gaps are historically resistant to clean automatic proofs. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 590. Problem 950 - Score 5
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory, primes, and binomial coefficients) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is a mix of exhaustive search, OEIS/literature retrieval, and then a compact certificate or counterexample-style proof. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 592. Problem 1167 - Score 5
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. The recorded prize ($5000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags and statement (number theory, additive combinatorics, and arithmetic progressions) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature mining for a sharp additive-combinatorics lemma and then proof reconstruction around a concrete extremal sequence. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 594. Problem 919 - Score 5
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory and chromatic number) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 595. Problem 675 - Score 4
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (irrationality) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 599. Problem 1200 - Score 4
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory, ramsey theory, and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 604. Problem 711 - Score 3
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize (INR 1000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 605. Problem 623 - Score 3
...
- Assessment: The statement is already marked formalized, which is a strong positive signal for AI because the definitions have likely been made precise enough for proof assistants or formal proof search. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 606. Problem 687 - Score 3
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory, chromatic number, and hypergraphs) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 608. Problem 111 - Score 2
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory, chromatic number, and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 609. Problem 710 - Score 2
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize (INR 2000) is a negative signal, since high-prize Erdos problems tend to be well-known and resistant to standard attacks. The tags (number theory) do not by themselves identify a highly automated route, so the score leans more on formalization, prize, and statement shape. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has OEIS links, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 610. Problem 62 - Score 2
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 611. Problem 671 - Score 2
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. The recorded prize ($250) suggests meaningful difficulty, but not enough by itself to rule out AI-aided progress. The tags and statement (analysis) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 612. Problem 598 - Score 2
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (set theory and combinatorics) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 614. Problem 261 - Score 1
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (number theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to combine literature search with a targeted formalization of the strongest nearby partial result. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 615. Problem 603 - Score 1
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (combinatorics and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is literature retrieval and formalization support; I would not expect near-term autonomous proof search to handle the central insight. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 616. Problem 638 - Score 1
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory and ramsey theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 617. Problem 597 - Score 1
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory, ramsey theory, and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. The page has finite search hooks, which improves the odds that an AI agent can connect it to existing literature or experiments.

### 618. Problem 70 - Score 1
...
- Assessment: The statement is not marked formalized, so an AI would first need to disambiguate and formalize the problem before proof search could become useful. No Erdos prize is recorded, which I count as a positive signal: it is less likely to be one of the famous high-resistance benchmark problems. The tags and statement (graph theory, ramsey theory, and set theory) point toward deeper theory, so I downgrade autonomous proof prospects and mostly expect AI to help with search, exposition, or formalization. A likely AI route is to search for the right extremal construction or known lemma chain, then formalize a finite combinatorial argument. I did not see obvious machine-search hooks in the scraped statement snippet, so the score relies more on the broad mathematical area than on a concrete automated tactic.

### 619. Problem 1168 - Score 0
